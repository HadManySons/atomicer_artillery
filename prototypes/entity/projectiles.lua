...
data:extend({
    {
        ...
        picture = {
            filename = "__atomic-artillery-reborn__/graphics/entity/artillery-projectile/hr-atomic-shell.png",
            width = 64,
            height = 64,
            scale = 0.5,
        },
        ...
        chart_picture = {
            filename = "__atomic-artillery-reborn__/graphics/entity/artillery-projectile/atomic-artillery-shoot-map-visualization.png",
            flags = { "icon" },
            frame_count = 1,
            width = 64,
            height = 64,
